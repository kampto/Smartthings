...
*	Date:       Who:           What:
*	2020-12-09  kampto         Verified on ST, had to comment out things that work on Hubitat but not on ST.
...
metadata {
	definition (name: "Child Ultrasonic Tank Level Sensor", namespace: "kampto", author: "T. Kamp", 
		importUrl: "https://github.com/kampto/Smartthings/blob/main/Drivers/Child_Ultrasonic_Tank_Level_Sensor.groovy") {
			capability "Sensor"
