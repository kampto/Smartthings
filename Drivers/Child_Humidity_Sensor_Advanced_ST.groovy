/* Child Humidity Sensor Advanced ST
*  
...
*    Smartthings: This DH may compile on Smarthings IDE as of 2020, I commented things out that had some difficulty. 
...
*	Date:       Who:           What:
*	2020-12-09  kampto         Commented stuff out that might not compile in new ST IDE 
...
metadata {
	definition (name: "Child Humidity Sensor Advanced", namespace: "kampto", author: "T. Kamp", 
        importUrl: "https://github.com/kampto/Smartthings/blob/main/Drivers/Child_Humidity_Sensor_Advanced.groovy") {
